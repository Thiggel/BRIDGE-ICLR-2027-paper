...
\caption{Imposed imbalance on ImageNet-100 over three seeds. Balancing the classes changes SimCLR by 0.1 points, while \method\ on the long-tailed source adds 11.1 linear-probe and 7.3 $k$NN points.}
