...
\input{tables/main_diffaug}
\paragraph{DiffAug.} DiffAug learns its diffusion generator from the ImageNet-100-LT source itself. Under the same five cycles it reaches seven-task averages of 11.3 by linear probe and 22.0 by $k$NN, 31.2 and 11.6 points below \method\ (Table~\ref{tab:main_diffaug}). Adding \method\ to DiffAug moves both averages by less than half a point, inside seed variation.
